...
class RiskAttributesPredictors :
    ...
    def __init__(self, data_risk, qid_columns, categorical_attributs) :
        ...
        for attribute in self.risk_attributes :
            if attribute in  categorical_attributs :
    ...
    def evaluate_attributes_prediction_models(self, x_test, batch, columns_results, categorical_attributs) : 
        """Evaluate the prediction models for the risk attributes
