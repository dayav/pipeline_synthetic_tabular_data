...
OUTPUT_ROOT = BASE_RESULTS_DIR / "privacy_evaluation_pipeline_weighted"
...
def synth_runs() -> Iterable[Tuple[str, Path]]:
    ...
    base_folder = BASE_RESULTS_DIR / "epsilon_comparison_heom_any_weighted"
    for eps in epsilons:
        yield f"adult_ctgan_eps_{eps}_weighted", base_folder / f"adult_ctgan_eps_{eps}"
