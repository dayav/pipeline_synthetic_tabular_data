...
"""
Run privacy evaluation for the adult TVAE weighted run(s), using pipeline tasks
...
def synth_runs() -> Iterable[Tuple[str, Path]]:
    """
    Yield (label, folder) pairs for weighted TVAE runs.
    ...
    for eps in epsilons:
        yield f"adult_tvae_eps_{eps}_weighted_5", base_folder / f"adult_tvae_eps_{eps}"
