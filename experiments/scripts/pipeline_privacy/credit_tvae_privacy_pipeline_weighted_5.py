...
"""
Run privacy evaluation for the credit TVAE weighted run(s), using pipeline tasks
...
def synth_runs() -> Iterable[Tuple[str, Path]]:
    ...
    for eps in epsilons:
        yield f"credit_tvae_eps_{eps}_weighted_5", base_folder / f"credit_tvae_eps_{eps}"
