...
"""
Run privacy evaluation for the cardio CTGAN weighted run(s), using pipeline tasks
...
def synth_runs() -> Iterable[Tuple[str, Path]]:
    ...
    for eps in epsilons:
        yield f"cardio_ctgan_eps_{eps}_weighted_5", base_folder / f"cardio_ctgan_eps_{eps}"
