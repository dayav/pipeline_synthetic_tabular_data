...
def run() -> None:
    ...
    predictions_synth_adult_heom_any_adult_tvae_eps_0005 = evaluate_synthetic_prediction(df_train, adult_tvae_eps_0005, df_test)
    ...
    predictions_synth_adult_heom_any_adult_tvae_eps_001 = evaluate_synthetic_prediction(df_train, adult_tvae_eps_001, df_test)
    ...
    predictions_synth_adult_heom_any_adult_tvae_eps_005 = evaluate_synthetic_prediction(df_train, adult_tvae_eps_005, df_test)
    ...
    predictions_synth_adult_heom_any_adult_tvae_eps_01 = evaluate_synthetic_prediction(df_train, adult_tvae_eps_01, df_test)
    ...
    predictions_synth_adult_heom_any_adult_tvae_eps_015 = evaluate_synthetic_prediction(df_train, adult_tvae_eps_015, df_test)
    ...
    predictions_synth_adult_heom_any_adult_tvae_eps_02 = evaluate_synthetic_prediction(df_train, adult_tvae_eps_02, df_test)
    ...
    predictions_synth_adult_heom_any_adult_tvae_eps_025 = evaluate_synthetic_prediction(df_train, adult_tvae_eps_025, df_test)
    ...
    predictions_synth_adult_heom_any_adult_tvae_eps_03 = evaluate_synthetic_prediction(df_train, adult_tvae_eps_03, df_test)
    ...
    predictions_synth_adult_heom_any_adult_tvae_eps_035 = evaluate_synthetic_prediction(df_train, adult_tvae_eps_035, df_test)
    ...
    predictions_synth_adult_heom_any_adult_tvae_eps_04 = evaluate_synthetic_prediction(df_train, adult_tvae_eps_04, df_test)
