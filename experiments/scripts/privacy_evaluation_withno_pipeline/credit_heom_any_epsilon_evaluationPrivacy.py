...
def run() -> None:
    ...
    df_synth_ctgan = load_dataset_from_results('../baseline/credit_ctgan_baseline')
    df_synth_tvae = load_dataset_from_results('../baseline/credit_tvae_baseline')
    ...
    df_synth_ctgan = DataLoader.align_categoricals(df_synth_ctgan, df_train, CAT_COLS_CREDIT)
    df_synth_tvae = DataLoader.align_categoricals(df_synth_tvae, df_train, CAT_COLS_CREDIT)

    privacy_evaluator_qai_ctgan = PrivacyEvaluator(df_train, df_synth_ctgan, df_test, QAI_COLUMNS, RISK_COLUMNS, "none")

    _, _, _,_, predictions_dict_synth_credit_ctgan_heom_any_qai = privacy_evaluator_qai_ctgan.evaluate_attribute_synthetic_prediction()
    with open("predictions_dict_synth_credit_ctgan_heom_any_qai.pkl", "wb") as f:
        pickle.dump(predictions_dict_synth_credit_ctgan_heom_any_qai, f)

    privacy_evaluator_qai_tvae = PrivacyEvaluator(df_train, df_synth_tvae, df_test, QAI_COLUMNS, RISK_COLUMNS, "none")
    _, _, _,_, predictions_dict_synth_credit_tvae_heom_any_qai = privacy_evaluator_qai_tvae.evaluate_attribute_synthetic_prediction()
    with open("predictions_dict_synth_credit_tvae_heom_any_qai.pkl", "wb") as f:
        pickle.dump(predictions_dict_synth_credit_tvae_heom_any_qai, f)
    ...
    # predictions_synth_credit_heom_any_credit_ctgan_eps_0005 = evaluate_synthetic_prediction(df_train, credit_ctgan_eps_0005, df_test)
    ...
    # predictions_synth_credit_heom_any_credit_ctgan_eps_001 = evaluate_synthetic_prediction(df_train, credit_ctgan_eps_001, df_test)
    ...
    # predictions_synth_credit_heom_any_credit_ctgan_eps_005 = evaluate_synthetic_prediction(df_train, credit_ctgan_eps_005, df_test)
    ...
    # predictions_synth_credit_heom_any_credit_ctgan_eps_01 = evaluate_synthetic_prediction(df_train, credit_ctgan_eps_01, df_test)
    ...
    # predictions_synth_credit_heom_any_credit_ctgan_eps_015 = evaluate_synthetic_prediction(df_train, credit_ctgan_eps_015, df_test)
    ...
    # predictions_synth_credit_heom_any_credit_ctgan_eps_02 = evaluate_synthetic_prediction(df_train, credit_ctgan_eps_02, df_test)
    ...
    # predictions_synth_credit_heom_any_credit_ctgan_eps_025 = evaluate_synthetic_prediction(df_train, credit_ctgan_eps_025, df_test)
    ...
    # predictions_synth_credit_heom_any_credit_ctgan_eps_03 = evaluate_synthetic_prediction(df_train, credit_ctgan_eps_03, df_test)
    ...
    # predictions_synth_credit_heom_any_credit_ctgan_eps_035 = evaluate_synthetic_prediction(df_train, credit_ctgan_eps_035, df_test)
    ...
    # predictions_synth_credit_heom_any_credit_ctgan_eps_04 = evaluate_synthetic_prediction(df_train, credit_ctgan_eps_04, df_test)
