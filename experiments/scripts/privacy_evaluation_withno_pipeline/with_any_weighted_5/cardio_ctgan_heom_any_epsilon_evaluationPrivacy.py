...
def run() -> None:
    ...
    predictions_synth_cardio_heom_any_cardio_ctgan_eps_001 = evaluate_synthetic_prediction(df_train, synth, df_test, '001')
    with open("cardio/predictions_synth_cardio_heom_any_cardio_ctgan_eps_001.pkl", "wb") as f:
