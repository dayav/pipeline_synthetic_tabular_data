...
def run() -> None:
    ...
    predictions_synth_adult_heom_any_adult_ctgan_eps_001 = evaluate_synthetic_prediction(df_train, synth, df_test, '001')
    with open("adult/predictions_synth_adult_heom_any_adult_ctgan_eps_001.pkl", "wb") as f:
