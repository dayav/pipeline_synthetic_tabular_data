...
def run() -> None:
    ...
    predictions_synth_credit_heom_any_credit_tvae_eps_001 = evaluate_synthetic_prediction(df_train, synth, df_test, '001')
    with open("credit/predictions_synth_credit_heom_any_credit_tvae_eps_001.pkl", "wb") as f:
