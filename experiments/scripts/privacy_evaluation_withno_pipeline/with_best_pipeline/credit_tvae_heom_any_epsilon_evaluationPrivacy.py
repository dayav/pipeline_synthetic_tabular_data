...
def evaluate_synthetic_prediction(df_train, synth, df_test, eps) :
    ...
    with open(f"credit/credit_tvae_attributes_synthetic_models_{eps}.pkl", "wb") as f:
...
def run() -> None:
    ...
    # with open("predictions_dict_real_credit_tvae_heom_any_qai.pkl", "wb") as f:
    ...
    # with open(f"credit/credit_tvae_attributes_synthetic_models_none.pkl", "wb") as f:
    #     pickle.dump(privacy_evaluator_qai_synth.attributes_synthetic_models, f)

    # with open(f"credit/credit_tvae_attributes_real_models.pkl", "wb") as f:
    #     pickle.dump(privacy_evaluator_qai_synth.attributes_real_models, f)


    # predictions_synth_credit_heom_any_credit_tvae_eps_0005 = evaluate_synthetic_prediction(df_train, credit_tvae_eps_0005, df_test, '0005')
    ...
    # predictions_synth_credit_heom_any_credit_tvae_eps_001 = evaluate_synthetic_prediction(df_train, credit_tvae_eps_001, df_test, '001')
    ...
    # predictions_synth_credit_heom_any_credit_tvae_eps_005 = evaluate_synthetic_prediction(df_train, credit_tvae_eps_005, df_test, '005')
    ...
    # predictions_synth_credit_heom_any_credit_tvae_eps_01 = evaluate_synthetic_prediction(df_train, credit_tvae_eps_01, df_test, '01')
    ...
    # predictions_synth_credit_heom_any_credit_tvae_eps_015 = evaluate_synthetic_prediction(df_train, credit_tvae_eps_015, df_test, '015')
    ...
    # predictions_synth_credit_heom_any_credit_tvae_eps_02 = evaluate_synthetic_prediction(df_train, credit_tvae_eps_02, df_test, '02')
    ...
    # predictions_synth_credit_heom_any_credit_tvae_eps_025 = evaluate_synthetic_prediction(df_train, credit_tvae_eps_025, df_test, '025')
    ...
    # predictions_synth_credit_heom_any_credit_tvae_eps_03 = evaluate_synthetic_prediction(df_train, credit_tvae_eps_03, df_test, '03')
    ...
    predictions_synth_credit_heom_any_credit_tvae_eps_035 = evaluate_synthetic_prediction(df_train, credit_tvae_eps_035, df_test, '035')
    ...
    # predictions_synth_credit_heom_any_credit_tvae_eps_04 = evaluate_synthetic_prediction(df_train, credit_tvae_eps_04, df_test, '04')
