...
def run() -> None:
    ...
    adult_ctgan_heom_any_weighted_eps_001  = load_all_results('../../../results/epsilon_comparison_heom_any_weighted/adult_ctgan_eps_0.01')
    adult_ctgan_heom_any_weighted_5_eps_001  = load_all_results('../../../results/epsilon_comparison_heom_any_weighted_5/adult_ctgan_eps_0.01')

    adult_tvae_heom_any_eps_001  = load_all_results('../../../results/epsilon_comparison_heom_any/adult_tvae_eps_0.01')
    adult_tvae_heom_any_weighted_eps_001  = load_all_results('../../../results/epsilon_comparison_heom_any_weighted/adult_tvae_eps_0.01')
    adult_tvae_heom_any_weighted_5_eps_001  = load_all_results('../../../results/epsilon_comparison_heom_any_weighted_5/adult_tvae_eps_0.01')

    dict_results_adult_ctgan  = {
        # 'adult CTGAN' : adult_ctgan,
        'adult CTGAN no-weighted' : adult_ctgan_heom_any_eps_001,
        'adult CTGAN weighted' : adult_ctgan_heom_any_weighted_eps_001,    
        'adult CTGAN weighted 5' : adult_ctgan_heom_any_weighted_5_eps_001,    
    }

    dict_results_adult_tvae  = {
        # 'adult TVAE' : adult_tvae,
        'adult TVAE no-weighted' : adult_tvae_heom_any_eps_001,
        'adult TVAE weighted' : adult_tvae_heom_any_weighted_eps_001,    
        'adult TVAE weighted 5' : adult_tvae_heom_any_weighted_5_eps_001,    
    ...
    for sensitive_feat in RISK_COLUMNS :
        ...
        for key , results in dict_results_adult_ctgan.items() :
        ...
        with open(f"../../../results/epsilon_disclosure_protection_comparison_heom_any_weighted/adult_ctgan_disclosure_protection_{sensitive_feat}.pkl", "wb") as f:
    ...
    for sensitive_feat in RISK_COLUMNS :
        ...
        for key , results in dict_results_adult_tvae.items() :
        ...
        with open(f"../../../results/epsilon_disclosure_protection_comparison_heom_any_weighted/adult_tvae_disclosure_protection_{sensitive_feat}.pkl", "wb") as f:
            pickle.dump(scores, f)
