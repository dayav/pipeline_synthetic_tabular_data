...
def run() -> None:
    ...
    #     with open(f"../../../results/epsilon_disclosure_protection_comparison_heom_any/credit_ctgan_disclosure_protection_{sensitive_feat}.pkl", "wb") as f:
    ...
    for sensitive_feat in RISK_COLUMNS :
        ...
        with open(f"../../../results/epsilon_disclosure_protection_comparison_heom_any/credit_tvae_new_disclosure_protection_{sensitive_feat}.pkl", "wb") as f:
            pickle.dump(scores, f)
