...
def main():
    ...
    def objective(trial):
        ...
        ctgan = SDVTVAE_( metadata, df_real_credit_card_train, enforce_min_max_values=True, enforce_rounding=True,
    ...
    file_name = f"study_tvae_credit.pkl"
    with open(file_name, 'wb') as file:
        # Serialize the object and write it to the file
        pickle.dump(study, file)
    json_file_name = f"study_tvae_credit.json"
