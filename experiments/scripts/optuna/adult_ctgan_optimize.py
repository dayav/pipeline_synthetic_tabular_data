...
def main():
    ...
    def objective(trial):
        ...
        ctgan = SDVCTGAN_( metadata, df_real_adult_train, enforce_min_max_values=True, enforce_rounding=True, locales=None,
    ...
    file_name = f"study_ctgan_adult.pkl"
    with open(file_name, 'wb') as file:
        # Serialize the object and write it to the file
        pickle.dump(study, file)
    json_file_name = f"study_ctgan_adult.json"
