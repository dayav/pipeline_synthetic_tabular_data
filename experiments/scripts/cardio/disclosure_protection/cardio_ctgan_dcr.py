...
def run() -> None:
    ...
    with open(f"../../../results/epsilon_disclosure_protection_comparison_heom_any/cardio_ctgan_dcr_protection.pkl", "wb") as f:
    ...
    with open(f"../../../results/epsilon_disclosure_protection_comparison_heom_any/cardio_tvae_dcr_protection.pkl", "wb") as f:
        pickle.dump(scores, f)
