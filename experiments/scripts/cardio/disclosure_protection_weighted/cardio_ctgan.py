...
def run() -> None:
    ...
    cardio_ctgan_heom_any_weighted_eps_001  = load_all_results('../../../results/epsilon_comparison_heom_any_weighted/cardio_ctgan_eps_0.01')
    cardio_ctgan_heom_any_weighted_5_eps_001  = load_all_results('../../../results/epsilon_comparison_heom_any_weighted_5/cardio_ctgan_eps_0.01')

    cardio_tvae_heom_any_eps_001  = load_all_results('../../../results/epsilon_comparison_heom_any/cardio_tvae_eps_0.01')
    cardio_tvae_heom_any_weighted_eps_001  = load_all_results('../../../results/epsilon_comparison_heom_any_weighted/cardio_tvae_eps_0.01')
    cardio_tvae_heom_any_weighted_5_eps_001  = load_all_results('../../../results/epsilon_comparison_heom_any_weighted_5/cardio_tvae_eps_0.01')

    dict_results_cardio_ctgan  = {
        # 'cardio CTGAN' : cardio_ctgan,
        'cardio CTGAN no-weighted' : cardio_ctgan_heom_any_eps_001,
        'cardio CTGAN weighted' : cardio_ctgan_heom_any_weighted_eps_001,    
        'cardio CTGAN weighted 5' : cardio_ctgan_heom_any_weighted_5_eps_001,    
    }

    dict_results_cardio_tvae  = {
        # 'cardio TVAE' : cardio_tvae,
        'cardio TVAE no-weighted' : cardio_tvae_heom_any_eps_001,
        'cardio TVAE weighted' : cardio_tvae_heom_any_weighted_eps_001,    
        'cardio TVAE weighted 5' : cardio_tvae_heom_any_weighted_5_eps_001,    
    ...
    for sensitive_feat in RISK_COLUMNS :
        ...
        for key , results in dict_results_cardio_ctgan.items() :
        ...
        with open(f"../../../results/epsilon_disclosure_protection_comparison_heom_any_weighted/cardio_ctgan_disclosure_protection_{sensitive_feat}.pkl", "wb") as f:
    ...
    for sensitive_feat in RISK_COLUMNS :
        ...
        for key , results in dict_results_cardio_tvae.items() :
        ...
        with open(f"../../../results/epsilon_disclosure_protection_comparison_heom_any_weighted/cardio_tvae_disclosure_protection_{sensitive_feat}.pkl", "wb") as f:
            pickle.dump(scores, f)
